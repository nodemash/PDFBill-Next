...
if (isset($_GET['send'])) {
    ...
    xtc_pdf_bill($_GET['oID'], true, true);

// without Mail - just generate
} else { 
    xtc_pdf_bill($_GET['oID'], false, true);
}
?>
...
<br/>
<br/>
<?php echo PDF_PRINT_PACKINGSLIP_DL_TEXT; ?> <a href="invoice/<?php echo PDF_FILENAME_SLIP . $_GET['oID']; ?>.pdf"><?php echo PDF_PRINT_PACKINGSLIP_DL; ?></a>
<br/>
<br/>
